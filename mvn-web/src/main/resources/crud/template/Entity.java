...
/**
 * ${table.entity} generated by codeTool
 * @author cielo
 * @date ${now}
 */
@Entity
...
public class ${table.entity} implements java.io.Serializable {
	...
	#foreach( $column in $columns )
		...
		@Column(name = "${column.columnName}"#if( ${column.length} ) ,  length = ${column.length} #end #if( ${column.unique} ) , unique = ${column.unique} #end #if( ${column.nullable} == 0 ) , nullable = false #end)
